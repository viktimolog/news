  ...
  return (
    <div style={{display: 'flex', width: '100%', justifyContent: 'center'}}>
      <Card
        style={Styles}
      >
        <div style={{display: 'flex', width: '30%', justifyContent: 'center', border: '1px', borderStyle: 'solid'}}>
          <CardMedia>
            <img src={item.general.avatar}/>
          </CardMedia>
        </div>

        <div style={{display: 'flex', width: '60%', justifyContent: 'center', border: '1px', borderStyle: 'solid'}}>
          <CardContent>
            <Typography color="secondary" gutterBottom variant="display1" component="h2">
              {item.general.firstName} {item.general.lastName}
            </Typography>

            <Typography color="primary" gutterBottom variant="headline" component="h2">{TextConstants.JOBTITLE}</Typography>
            <Typography gutterBottom component="p">{item.job.title}</Typography>

            <Typography color="primary" gutterBottom variant="headline" component="h2">{TextConstants.CONTACTTITLE}</Typography>
            <Typography component="p">{item.contact.email}</Typography>
            <Typography gutterBottom component="p">{item.contact.phone}</Typography>

            <Typography color="primary" gutterBottom variant="headline" component="h2">{TextConstants.ADDRESSTITLE}</Typography>
        ...
        <div style={{display: 'flex', width: '10%', justifyContent: 'flex-end', border: '1px', borderStyle: 'solid'}}>
          <CardActions>
            <Button
              style={{margin: -14}}
              size="small"
